...
export const DepartmentContact = IDL.Record({
  'name' : IDL.Text,
...
export const CompanyInfo = IDL.Record({
  ...
  'operatingAreas' : IDL.Record({
    'germany' : IDL.Text,
    'outsideEurope' : IDL.Text,
    'surroundingCountries' : IDL.Text,
  }),
});
...
export const idlService = IDL.Service({
  ...
  'addLead' : IDL.Func([Lead], [], []),
  'assignCallerUserRole' : IDL.Func([IDL.Principal, UserRole], [], []),
  'deleteAllLeads' : IDL.Func([], [], []),
  'deleteLead' : IDL.Func([IDL.Text], [], []),
  'getAllLeadsSortedByName' : IDL.Func([], [IDL.Vec(Lead)], ['query']),
...
export const idlFactory = ({ IDL }) => {
  ...
  const DepartmentContact = IDL.Record({
    'name' : IDL.Text,
    'description' : IDL.Opt(IDL.Text),
    'email' : IDL.Text,
    'phone' : IDL.Text,
